...
go run -tags x11 ./cmd/client -server localhost:7000    # 客户端（Windows 省略 -tags x11）
go run -tags x11 ./cmd/mapviewer ./asset/client/Map/0.map   # 地图查看器
go run -tags x11 ./cmd/wilviewer ./asset/client/Data        # WIL 资源查看器
```
